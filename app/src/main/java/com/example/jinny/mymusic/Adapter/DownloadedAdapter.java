...
public class DownloadedAdapter extends RecyclerView.Adapter<DownloadedAdapter.TopSongViewHolder> {
    List<TopSongModel> topSongModels = Utils.getListDownloadSong();
    ...
    public class TopSongViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(final TopSongModel topSongModel) {
            Picasso.get().load(R.drawable.meow).transform(new CropCircleTransformation()).into(ivTopSong);
